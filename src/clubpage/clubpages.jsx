...
import { responsable } from './reponsable'
                ...
                <Container>
                    <div class={styles.contenu}>
                        <div class={styles.left}>
                            <Contenu contenu={contenu()} pdf={pdf} titre={titre} club={content} />
...
function Contenu({ contenu, pdf, titre, club }) {

    const respo = responsable
    const trie = () => {
        const respoClub = respo.filter(el => el.club === club)
        return respoClub;
    }
    ...
    return (
        <div class={styles.leftContenu}>
            ...
            <div style={{ margin: '5rem 0' }}>
                <h1>Membre de l'équipe technique</h1>
